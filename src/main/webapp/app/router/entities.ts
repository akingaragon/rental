...
const Availability = () => import('@/entities/availability/availability.vue');
const AvailabilityUpdate = () => import('@/entities/availability/availability-update.vue');
const AvailabilityDetails = () => import('@/entities/availability/availability-details.vue');
...
export default {
  ...
  children: [
    ...
    {
      path: 'availability/:availabilityId/edit',
      name: 'AvailabilityEdit',
      component: AvailabilityUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'availability/:availabilityId/view',
