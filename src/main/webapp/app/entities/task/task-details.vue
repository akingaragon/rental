    ...
    <div class="col-8">
      <div v-if="task">
        <h2 class="jh-entity-heading" data-cy="taskDetailsHeading">
          <span v-text="t$('turkishrentalApp.task.detail.title')"></span> {{ task.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="t$('turkishrentalApp.task.title')"></span>
          </dt>
          <dd>
            <span>{{ task.title }}</span>
          </dd>
          <dt>
            <span v-text="t$('turkishrentalApp.task.description')"></span>
          </dt>
          <dd>
