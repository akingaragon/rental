  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="turkishrentalApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('turkishrentalApp.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('turkishrentalApp.department.departmentName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('turkishrentalApp.department.location')" for="department-location"></label>
